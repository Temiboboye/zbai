    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.infoBox}>
                <p>
                    <strong>📊 Email Domain Sorter:</strong> Automatically categorize your email list by provider
                    (Office 365, G Suite, or other domains). Perfect for targeted campaigns!
                </p>
            </div>

            <div className={styles.inputSection}>
                <h2>Sort Emails by Domain</h2>
